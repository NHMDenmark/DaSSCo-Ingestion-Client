/**
 * Used to store tus upload urls in order to resume interrupted uploads.
 * The code has been taken from the tus-js-client library:
 * https://github.com/tus/tus-js-client/blob/main/lib/node/urlStorage.js
*/
...
export default class FileUrlStorage {
